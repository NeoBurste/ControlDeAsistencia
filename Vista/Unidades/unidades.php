    ...
    <div class="d-flex">
        <nav class="sidebar-custom">
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2">
                    <a class="nav-link active" href="unidades.php">Unidades</a>
                </li>
                <li class="nav-item mb-2">
                    <a class="nav-link" href="../OrdenesInternas/ordenesInternasInicio.php">Órdenes Internas</a>
                </li>
            </ul>
        </nav>
        ...
        <div class="flex-grow-1">
            ...
            <div class="modal fade" id="modalModificarUnidad" tabindex="-1" aria-labelledby="modalModificarUnidadLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form id="formModificarUnidad" action="../../Controlador/Unidades/modificarUnidad.php" method="POST">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label for="mod_correo_electronico" class="form-label">Correo Electrónico</label>
