...
<body>
    ...
    <div class="d-flex">
        <nav class="sidebar-custom" id="sidebarMenu">
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2">
                    <a class="nav-link active" href="RegistroDeBienes.php">Registro de Bienes</a>
                </li>
                <li class="nav-item mb-2">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="editNombreProducto"
                                                    name="nombreProducto" maxlength="100" required autocomplete="off">
                                            </div>
                                            <div class="mb-3">
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="nombreProducto"
                                                    maxlength="100" required autocomplete="off" name="nombreProducto">
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="idCategoriaProducto" name="idCategoria"
                                                    required>
                                                    <option value="">Seleccione una categoria</option>
                                                    <?php
                                                    require_once '../../Modelo/Conexion.php';
